 ...
 */
package es.us.atc.jaer.chips.retina;
...
public class DVS128_PAER extends AETemporalConstastRetina implements Serializable, Observer, RemoteControlled {
    ...
    public DVS128_PAER() {
        ...
        setBiasgen((dvs128Biasgen = new DVS128_PAER.Biasgen(this)));
     ...
     * biasgen.
     */
    public DVS128_PAER(HardwareInterface hardwareInterface) {
        this();
    ...
    public void setHardwareInterface(final HardwareInterface hardwareInterface) {
        ...
        try {
            if (getBiasgen() == null) {
                setBiasgen(new DVS128_PAER.Biasgen(this));
            } else {
...
//        }
        ...
        public JPanel buildControlPanel() {
            ...
            pane.addTab("Basic controls", basicTab = new DVSFunctionalControlPanel(DVS128_PAER.this));
